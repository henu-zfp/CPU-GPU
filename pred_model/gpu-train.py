"""Train a Random Forest model to predict GPU execution time."""
...
def load_dataset(csv_path: Path) -> Tuple[List[List[float]], List[float]]:
    """Load the GPU dataset from ``gpu.csv`` and split features/target."""
...
def main() -> None:
    ...
    print("Training complete for GPU model")
